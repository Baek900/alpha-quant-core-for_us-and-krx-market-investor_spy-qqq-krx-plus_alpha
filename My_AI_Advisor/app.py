...
def run_simulation(price_df, df_logs, init_cap, strategy_mode, lev_mult=1):
    ...
    for chg in lev_changes[1:]:
        new_price = sim_price_series[-1] * (1 + chg)
        sim_price_series.append(max(0.01, new_price))
